...
import { format, startOfWeek, addDays, isToday, parseISO, startOfDay, endOfDay } from "date-fns";
    ...
    <AppLayout>
      <div className="p-4 md:p-6 space-y-6 max-w-6xl mx-auto">
        <PageHeader
          ...
          description="Plan your day, focus deeply, and understand your time"
        />
              ...
              <CardContent className="p-4">
                {isLoading ? (
                  ...
                  <div className="text-center py-8 text-muted-foreground">
                    ...
                    <p className="text-sm">Add blocks to plan your day</p>
                  </div>
                ) : (
              ...
              <CardContent className="space-y-6">
                ...
                {!isTimerRunning ? (
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button onClick={completeSession} variant="default" className="flex-1 gap-2">
                  ...
                  <div className="flex gap-2 justify-center">
                    {[15, 25, 45, 60].map((mins) => (
                      <Button
                        ...
                        className={timerMinutes === mins ? "bg-primary/20" : ""}
                      >
                        {mins}m
                      </Button>
                    ))}
                    ...
                    {focusSessions.slice(0, 10).map((session) => (
                      <div key={session.id} className="p-3 rounded-lg bg-muted/50 flex items-center justify-between">
                        ...
                        <div className="text-right">
                          <div className="font-medium text-primary">{session.duration_minutes}m</div>
                        </div>
                      </div>
                    ))}
                  </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-muted-foreground text-sm mt-1">Total focused time this week</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-muted-foreground text-sm mt-1">Focus sessions completed</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-4xl font-bold text-primary">
                  {focusSessions.length > 0 
                    ? Math.round(focusSessions.reduce((a, s) => a + s.duration_minutes, 0) / focusSessions.length)
                    : 0}m
                </div>
                <p className="text-muted-foreground text-sm mt-1">Average focus duration</p>
              </CardContent>
            </Card>
            ...
            <Card className="md:col-span-2 lg:col-span-3">
              ...
              <CardContent>
                {Object.keys(weeklyStats.byCategory).length === 0 ? (
                  <div className="text-center py-8 text-muted-foreground">
